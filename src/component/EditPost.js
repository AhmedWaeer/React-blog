...
const EditPost = () => {
  ...
  return (
    ...
    <section class="w-full max-w-md ml-0 px-6 py-4 bg-white rounded dark:bg-gray-800 border border-gray-400">
      <h2 class="text-3xl font-semibold text-center text-gray-800 dark:text-white">Edit Post</h2>
      <div class="mt-6 ">
        ...
        <div class="flex justify-center mt-6 gap-5">
          <button class="px-4 py-2 text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Update</button>

          <button class="px-4 py-2 text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Delete</button>
        </div>
      </div>
    </section>
  )
